...
class EditIncidentRepo {
  final ApiService apiService;

  EditIncidentRepo({required this.apiService});

  Future<ApiResult> editIncident(CurrentIncidentModel incident, int id) async {
    try {
      final response = await apiService.editCurrentIncident(id, incident);
