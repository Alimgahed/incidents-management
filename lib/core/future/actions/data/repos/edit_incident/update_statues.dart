...
class UpdateStatuesRepo {
  final ApiService apiService;

  UpdateStatuesRepo({required this.apiService});

  Future<ApiResult> updateStatues(
    CurrentIncidentWithMissions incident,
    int id1,
    int id2,
    int id3,
  ) async {
    try {
      final response = await apiService.editCurrentMission(
        id1,
        id2,
        id3,
        incident.toJson(),
