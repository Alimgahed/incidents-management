...
class AddIncidentTypeWeb extends StatefulWidget {
  ...
  @override
  State<AddIncidentTypeWeb> createState() => _AddIncidentTypeWebState();
}

class _AddIncidentTypeWebState extends State<AddIncidentTypeWeb> {
  @override
            ...
            children: [
              Row(
                children: [
                  ...
                  Text("أنواع الأزمات", style: TextStyle(color: Colors.grey[600], fontSize: 13)),
                  const Padding(padding: EdgeInsets.symmetric(horizontal: 8), child: Icon(Icons.chevron_left, size: 16, color: Colors.grey)),
                  const Text("إضافة نوع جديد", style: TextStyle(color: appColor, fontSize: 13, fontWeight: FontWeight.bold)),
                ],
              ),
              const SizedBox(height: 8),
              const Text("إضافة نوع أزمة جديد", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: Color(0xFF1E293B))),
            ],
          ),
        ],
      ),
  ...
  Widget _buildBasicInfoCard(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text("المعلومات الأساسية", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF334155))),
          const SizedBox(height: 8),
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                onPressed: () => context.read<AddIncidentTypeCubit>().saveIncidentType(),
                icon: const Icon(Icons.check, color: Colors.white, size: 18),
                label: const Text("حفظ الأزمة", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ],
